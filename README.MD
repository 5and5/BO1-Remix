...
### Theif
* First theif round is always the next odd round after you turn on power
...
* VR11 displays amount of time left next to weapon name
...
#### TODO
* Add timer to vr11
* disable door that dont need to be opened
* Move double tap on kino
