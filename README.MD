...
* Increased red screen thresh hold from 20% to 25%

## Zombie Spawns
* Reduced round one spawn delay from 2 to 1 seconds (round 15 spawn rate)
* Spawn delay now caps out at round 50 instead of 63
* Removed limit of 3 zombies jumping over a barrier at one time
* Zombies jump through barriers quicker now
...
## Traps
#### General
* Trap light no longer gets glitched by hitting the switch to early
...
## TODO
* change powerup on the map time to 30 seconds
* remove one player drinking perk limit
* update health bar

#### Shang
* find a way to fix cycle without carps
* monkeys come at any round
* make ceiling spawner faster

#### Moon
* wavegun respawn zombie as soon as they are killed
* wavegun to act like overrun wavegun
* remove astro
* hacked max ammos turn into perk bottles till you have all the perks
