...
timer_hud()
{
	...
	level thread maps\_custom_hud_menu::coop_pause(level.timer, level.beginning_timestamp);
...
hud_trade_weapons1()
{
	...
	self.trade_weapon1.color = level.trade_header.color;
...
hud_trade_weapons2()
{
	...
	self.trade_weapon2.color = level.trade_header.color;
...
hud_trade_weapons3()
{
	...
	self.trade_weapon3.color = level.trade_header.color;
...
hud_trade_weapons4()
{
	...
	self.trade_weapon4.color = level.trade_header.color;
...
hud_trade_boxhits()
{
	...
	self.trade_boxhits.color = level.trade_header.color;
...
hud_trade_average()
{
	...
	self.trade_ww_average.color = level.trade_header.color;
...
hud_current_box()
{
	...
	self.trade_current_box_location.color = level.trade_header.color;
...
hud_setup_boxhits()
{
	...
	self.trade_setup_boxhits.color = level.trade_header.color;
